    ...
    <div style=" margin:10px 0">
      ...
      >
        <el-form  :model="form" label-width="120px">
          ...
          <el-form-item label="designator">
            <el-input v-model="form.designator" style="width:80%"></el-input>
          </el-form-item>

          <el-form-item label="footprint">
            
            <el-input v-model="form.footprint" style="width:80%"></el-input>
            <!-- <el-radio v-model="form.sex" label="女">女</el-radio>
            <el-radio v-model="form.sex" label="未知">未知</el-radio> -->
          </el-form-item>

          <el-form-item label="quantity">
            <el-input  v-model="form.quantity" style="width:80%"></el-input>
          </el-form-item>
        </el-form>
